...
func TestTransactionsUsesResponseCursorAndParsesV3Fields(t *testing.T) {
	...
	Client = &http.Client{
		Transport: roundTripFunc(func(req *http.Request) (*http.Response, error) {
			...
			case "/api/v3/users/user-123/transactions":
				...
				if after == "" {
					return jsonResponse(`{"data":{"transactions":[{"uuid":"txn-1","amount":551,"source_amount":551,"current_balance":0,"txn_timestamp":"2026-03-10T09:31:21Z","mode":"CARD","type":"OUTGOING","source":"CREDIT_CARD","narration":"CARD/19cd71636decac8c/SWIGGY LIMITED/INR/551.00/OUTGOING/Mar 10 2026 at 03:01:10","merchant":{"name":"SWIGGY LIMITED","type":"f1","address":null},"category":{"id":"cat-food","subcategory_id":"sub-takeaway"},"account_id":"cc-account-1","financial_information_provider_id":"","tags":[],"kind":"NORMAL","notes":null,"excluded_from_cash_flow":false,"is_bookmarked":false,"transaction_id":"txn-1","reference":"","summary":"You spent ₹551","before_fold_account":false,"via":null,"account_in":null,"refund":{"status":"NONE","received_on":null},"group_ids":null,"contact_id":null,"is_f1_predicted":{"category_or_subcategory":true,"merchant":true},"currency":"INR","source_currency":"INR","user_manual_added":null,"split_type":"","parent_transaction_id":""}],"after":"cursor-1"}}`), nil
				}
				require.Equal(t, "cursor-1", after)
				return jsonResponse(`{"data":{"transactions":[{"uuid":"txn-2","amount":26000,"source_amount":26000,"current_balance":0,"txn_timestamp":"2026-03-05T06:38:30Z","mode":"CASH","type":"OUTGOING","source":"MANUAL","narration":"CASH/Houseowner/26000.00/DEBIT/2026-03-05/2026-03-05 06:38:30","merchant":{"name":"Houseowner","type":"custom","address":null},"category":{"id":"cat-bill","subcategory_id":"sub-rent"},"account_id":"cash-account-1","financial_information_provider_id":"","tags":[],"kind":"NORMAL","notes":null,"excluded_from_cash_flow":false,"is_bookmarked":false,"transaction_id":"txn-2","reference":"","summary":"You transferred ₹26K","before_fold_account":false,"via":null,"account_in":null,"refund":{"status":"NONE","received_on":null},"group_ids":null,"contact_id":null,"is_f1_predicted":{"category_or_subcategory":false,"merchant":false},"currency":"INR","source_currency":"INR","user_manual_added":true,"split_type":"","parent_transaction_id":""}],"after":""}}`), nil
			default:
	...
	require.Equal(t, "SWIGGY LIMITED", first.Merchant)
	require.Equal(t, "SWIGGY LIMITED", first.MerchantName)
